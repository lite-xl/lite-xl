...
RenFont* ren_font_load(RenWindow *window_renderer, const char* path, float size, ERenFontAntialiasing antialiasing, ERenFontHinting hinting, unsigned char style, RenFontLigatureOptions ligopt) {
  RenFont *font = NULL;
  FT_Face face = NULL;
...
RenFont* ren_font_copy(RenWindow *window_renderer, RenFont* font, float size, ERenFontAntialiasing antialiasing, ERenFontHinting hinting, int style, const RenFontLigatureOptions *ligopt) {
  ...
  return ren_font_load(window_renderer, font->path, size, antialiasing, hinting, style, _ligopt);
}
