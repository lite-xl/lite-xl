...
keymap.add {
  ...
  ["escape"] = { "command:escape", "doc:select-none", "nag:select-no" },
  ...
  ["return"] = { "command:submit", "doc:newline", "nag:select" },
  ["keypad enter"] = { "command:submit", "doc:newline", "nag:select" },
  ...
  ["left"] = { "doc:move-to-previous-char", "nag:previous-entry" },
  ["right"] = { "doc:move-to-next-char", "nag:next-entry"},
