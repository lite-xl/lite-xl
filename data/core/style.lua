...
style.font = renderer.font.load(window, DATADIR .. "/fonts/FiraSans-Regular.ttf", 15 * SCALE)
style.big_font = style.font:copy(window, 46 * SCALE)
style.icon_font = renderer.font.load(window, DATADIR .. "/fonts/icons.ttf", 16 * SCALE, {antialiasing="grayscale", hinting="full"})
style.icon_big_font = style.icon_font:copy(window, 23 * SCALE)
style.code_font = renderer.font.load(window, DATADIR .. "/fonts/JetBrainsMono-Regular.ttf", 15 * SCALE)
